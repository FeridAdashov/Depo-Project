...
public class DepoReturnSellsBySellerRecycler extends RecyclerView.Adapter<DepoReturnSellsBySellerRecycler.MyViewHolder> {

    private final ArrayList<String> nameList;
    private final ArrayList<String> searchNameList;
    private final ArrayList<ReturnSellBySellerModel> sellList;
    private final CustomProgressDialog progressDialog;
    private final Activity activity;

    public DepoReturnSellsBySellerRecycler(Activity activity,
                                           ArrayList<String> nameList,
                                           ArrayList<String> searchNameList,
                                           ArrayList<ReturnSellBySellerModel> sellList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View listItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_return_sells_by_seller_depo, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int pos) {
        ...
        ReturnSellBySellerModel sell = sellList.get(position);
        ...
        holder.sells.setOnClickListener(v -> {
            ...
            DatabaseFunctions.getDatabases(activity).get(0).child("RETURN/SELL/" + sell.date + "/" + sell.userName).
                    addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            for (DataSnapshot snapshotTime : snapshot.getChildren()) {
                                ...
                                if (time == null || time.equals("sum") || time.equals("percentSum"))
                                    continue;
                            ...
                            showTimesDialog("RETURN/SELL/" + sell.date + "/" + sell.userName, times);
                        }
    ...
    private void showTimesDialog(String child_name, ArrayList<String> times) {
        ...
        builder.setItems(times.toArray(new String[0]), (dialog, which) -> {
            ...
            intent.putExtra("isReturnSell", true);
