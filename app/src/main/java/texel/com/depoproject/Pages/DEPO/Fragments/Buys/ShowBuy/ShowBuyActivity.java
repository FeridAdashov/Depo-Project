...
public class ShowBuyActivity extends AppCompatActivity {
    ...
    private RecyclerShowBuy adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Alış");
    ...
    private void configureListViewProducts() {
        adapter = new RecyclerShowBuy(searchNameList, cardViewProductHashMap);
