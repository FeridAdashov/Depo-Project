...
public class DepoRecyclerReturnBuyHistory extends RecyclerView.Adapter<DepoRecyclerReturnBuyHistory.MyViewHolder> {
    ...
    public DepoRecyclerReturnBuyHistory(Activity activity,
    ...
    public void onBindViewHolder(MyViewHolder holder, final int pos) {
        ...
        holder.cardView.setOnClickListener(v -> showTimesDialog("RETURN/BUY/" + date));
    }
        ...
        DatabaseFunctions.getDatabases(activity).get(0).child(child_name).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                builder.setItems(times.toArray(new String[0]), (dialog, which) -> {
                    Intent intent = new Intent(activity, ShowReturnBuyActivity.class);
